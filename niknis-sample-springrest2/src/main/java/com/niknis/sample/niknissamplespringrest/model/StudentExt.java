...
/*
 static filtering through @JsonIgnore (for specific field) or @JsonIgnoreProperty(direct from top of class)
 */
@JsonIgnoreProperties(value= {"password","libraryCardNo"})
public class StudentExt {
	...
	public StudentExt(String password, Integer libraryCardNo, String faterName, String motherName, String address,
	...
	public String toString() {
		return "StudentExt [password=" + password + ", libraryCardNo=" + libraryCardNo + ", faterName=" + faterName
